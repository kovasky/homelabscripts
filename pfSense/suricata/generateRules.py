...
def generateRule(dnsName, currentSID, outputFile) -> None:
    ...
    if ipAddr:
        ...
        currentSID += 1
        inbound_rule = f'pass ip {ipAddr} any -> any any (msg:"Allow inbound connection from {ipAddr}"; sid:{currentSID};)\n'
        outputFile.write(inbound_rule)
...
if __name__ == "__main__":
    ...
    with open(inputFilePath, "r") as input_file, open(outputFilePath, "w") as outputFile:
        currentSID = 1
